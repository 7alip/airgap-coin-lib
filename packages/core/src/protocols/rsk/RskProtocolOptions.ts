...
export const BLOCK_EXPLORER_API: string = 'https://cors-proxy.airgap.prod.gke.papers.tech/proxy?url=https://blockscout.com/rsk/mainnet/' // TODO: Consider adding rsk explorer api
...
export class RskERC20ProtocolOptions extends RskProtocolOptions {
  constructor(
    public readonly network: RskProtocolNetwork = new RskProtocolNetwork(),
    public readonly config: RskERC20ProtocolConfig
  ) {
